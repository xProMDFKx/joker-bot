...
//SFSA
    if (message.content === "/salut") { // creates the command cookie
        if (args[1]) message.channel.send(message.author.toString() + " has given " + args[1].toString() + " un salut! :cookie:") // sends the message saying someone has given someone else a cookie if someone mentions someone else
...
//SFSA
  ...
  embed.addField('_xProMDFKx_#0957', false)
  embed.addField('MrLightt_#0907', false)
  embed.setColor(0x551B8C)
  message.channel.sendEmbed(embed)
...
if (message.content.startsWith(prefix + 'serverinfo1235')) {
  ...
  embed.setColor(0x551B8C) // sets the color of the embed box to orange
